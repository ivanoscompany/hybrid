<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		Група:<li class="breadcrumb-item active" aria-current="page"><?php echo $lastCategory['category_group_name'] ?></li>
	</ol>
</nav>
<table class="table">
	<thead>
			...
			<th>
				<div class="input-group mb-3">
					...
					<div class="input-group-append">
						...
						id:'<?php echo $lastCategory['category_group_id'] ?>',
						methodType:'PUT'
						}
						})">Добави</button>
					</div>
		...
		<tbody class="table-body-category">
			<?php include set::path('Admin', 'view', 'index/category/category-sub-table'); ?>
		</tbody>
	</table>	